...
def evaluate_resnet50():
    ...
    logger = setup_logger('ResNet50_Evaluation', 'models/resnet50/evaluation.log')
    
    logger.info("Loading model...")
    model = load_model('models/resnet50/weights/resnet50_best.h5')
    ...
    plot_confusion_matrix(
        ...
        class_names,
        'models/resnet50/confusion_matrix.png'
    )
