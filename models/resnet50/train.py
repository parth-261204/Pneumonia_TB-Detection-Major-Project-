...
from models.resnet50.model import create_resnet50_model, unfreeze_and_finetune
...
def train_resnet50():
    ...
    logger = setup_logger('ResNet50_Training', 'models/resnet50/training.log')
    ...
    plot_training_history(history1, 'models/resnet50/training_history.png')
