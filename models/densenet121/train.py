...
from models.densenet121.model import create_densenet121_model, unfreeze_and_finetune
...
def train_densenet121():
    ...
    logger = setup_logger('DenseNet121_Training', 'models/densenet121/training.log')
    ...
    os.makedirs('models/densenet121/weights', exist_ok=True)
    ...
    plot_training_history(history1, 'models/densenet121/training_history.png')
