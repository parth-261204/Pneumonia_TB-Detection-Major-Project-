...
def evaluate_densenet121():
    ...
    logger = setup_logger('DenseNet121_Evaluation', 'models/densenet121/evaluation.log')
    
    logger.info("Loading model...")
    model = load_model('models/densenet121/weights/densenet121_best.h5')
    ...
    plot_confusion_matrix(
        ...
        class_names,
        'models/densenet121/confusion_matrix.png'
    )
