...
from models.efficientnetb0.model import create_efficientnetb0_model, unfreeze_and_finetune
...
def train_efficientnetb0():
    ...
    logger = setup_logger('EfficientNetB0_Training', 'models/efficientnetb0/training.log')
    ...
    logger.info("Creating EfficientNetB0 model...")
    ...
    os.makedirs('models/efficientnetb0/weights', exist_ok=True)
    ...
    plot_training_history(history1, 'models/efficientnetb0/training_history.png')
