...
def evaluate_efficientnetb0():
    """Evaluate EfficientNetB0 model"""
    logger = setup_logger('EfficientNetB0_Evaluation', 'models/efficientnetb0/evaluation.log')
    
    logger.info("Loading model...")
    model = load_model('models/efficientnetb0/weights/efficientnetb0_best.h5')
    ...
    plot_confusion_matrix(
        ...
        class_names,
        'models/efficientnetb0/confusion_matrix.png'
    )
